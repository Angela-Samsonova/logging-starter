package ru.samsonovaa.loggingstarter.aspect;
...
import ru.samsonovaa.loggingstarter.annotation.LogExecutionTime;

@Aspect
public class LogExecutionAspect {
    private static final Logger log = LoggerFactory.getLogger(LogExecutionAspect.class);

    @Around("@annotation(ru.samsonovaa.loggingstarter.annotation.LogExecutionTime)")
    public Object aroundLogExecutionTimeMethod(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            log.info("Время выполнения метода {}: {} мс", method.getName(), System.currentTimeMillis() - start);
        }
    }
}
